...
const (
	ALARM_TYPE_COMMUNICATION      = model.ALARM_TYPE_COMMUNICATION
	ALARM_TYPE_EQUIPMENT          = model.ALARM_TYPE_EQUIPMENT
	ALARM_TYPE_PROCESSING_FAILURE = model.ALARM_TYPE_PROCESSING_FAILURE
	ALARM_TYPE_ENVIRONMENTAL      = model.ALARM_TYPE_ENVIRONMENTAL
	ALARM_TYPE_QUALITY_OF_SERVICE = model.ALARM_TYPE_QUALITY_OF_SERVICE
	...
	UENB_TYPE_ATTACH   = model.UENB_TYPE_ATTACH
	UENB_TYPE_TAU      = model.UENB_TYPE_TAU
	UENB_TYPE_HANDOVER = model.UENB_TYPE_HANDOVER
	...
	UENB_RESULT_AUTH_ILLEGAL                            = model.UENB_RESULT_AUTH_ILLEGAL
