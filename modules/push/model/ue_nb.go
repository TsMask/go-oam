...
const (
	...
	UENB_RESULT_AUTH_ILLEGAL                            = "008" // 终端接入基站认证结果-非法 008
...
const (
	...
	UENB_TYPE_ATTACH   = "ATTACH"   // 终端接入基站类型-附着
	UENB_TYPE_TAU      = "TAU"      // 终端接入基站类型-跟踪区更新
	UENB_TYPE_HANDOVER = "HANDOVER" // 终端接入基站类型-切换
)
